    ...
    <Box style={{
      ...
      <Box direction="column" align="center" justify="center" fill>
        <Box background={{
          color: "light-1",
          opacity: 0.8
        }} align={"center"} justify="center" elevation={"medium"} width={"80%"} pad={"40px"} round>
          <Box><span style={{ "textAlign": "center", "textShadow": "0 2px 0 4px rgba(0,0,0,0.1)"}}><strong>{props.question}</strong></span></Box>
          <Box><span style={{ "textAlign": "center", "textShadow": "0 2px 0 4px rgba(0,0,0,0.1)"}}>{props.studentName}, Grade {props.grade}</span></Box>
        </Box>
      </Box>
    </Box>
  </Box>
  ...
  return <Box direction="column">
    ...
    <Carousel heightMode="current" slidesToShow={4} wrapAround renderBottomCenterControls={null}>
      ...
      <QuestionCard
        ...
        image={napoleon}
      />
      <QuestionCard priority={2} question={"What is global warming?"} studentName={"Hetal Girishbhai"} grade={8} image={globalWarming}/>
      <QuestionCard priority={2} question={"What are the uses of a cylinder?"} studentName={"Aman"} grade={8} image={cylinder}/>
      <QuestionCard priority={2} question={"Snakes don't have any ears. How are they able to hear?"} studentName={"Anjuman Banu"} grade={7} image={snakesHearing}/>
      <QuestionCard priority={2} question={"Why does the moon look half?"} studentName={"Saiba"} grade={7} image={moonHalf} />
      <QuestionCard priority={2} question={"Why is mango called the king of fruits?"} studentName={"Jatin"} grade={5} image={mango}/>
    </Carousel>
  </Box>
}
